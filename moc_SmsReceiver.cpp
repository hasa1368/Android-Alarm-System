...
Q_CONSTINIT static const uint qt_meta_data_CLASSSmsReceiverENDCLASS[] = {
 ...
 // properties: name, type, flags
       3, QMetaType::QStringList, 0x00015003, uint(0), 0,
...
void SmsReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->smsMessagesListChanged(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SmsReceiver::*)();
            if (_t _q_method = &SmsReceiver::smsMessagesListChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QStringList*>(_v) = _t->m_smsMessagesList; break;
        default: break;
        }
        ...
        switch (_id) {
        case 0:
            if (_t->m_smsMessagesList != *reinterpret_cast< QStringList*>(_v)) {
                _t->m_smsMessagesList = *reinterpret_cast< QStringList*>(_v);
                Q_EMIT _t->smsMessagesListChanged();
            }
            break;
        default: break;
        }
...
// SIGNAL 0
void SmsReceiver::smsMessagesListChanged()
{
